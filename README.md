<div align="center">
  ...
  <p align="center">
    <a href="https://readme-typing-svg.herokuapp.com?font=Inter&weight=600&size=20&duration=3000&pause=1000&color=2563EB&center=true&vCenter=true&width=500&lines=Enterprise+Workflow+Intelligence;Autonomous+AI+Agents;Digital+Twin+Platform;Workflow+Optimization;Knowledge+Graph+Intelligence">
      <img src="https://readme-typing-svg.herokuapp.com?font=Inter&weight=600&size=20&duration=3000&pause=1000&color=2563EB&center=true&vCenter=true&width=500&lines=Enterprise+Workflow+Intelligence;Autonomous+AI+Agents;Digital+Twin+Platform;Workflow+Optimization;Knowledge+Graph+Intelligence" alt="Typing SVG" />
    </a>
  </p>

  <p align="center">
    <a href="https://github.com/Noufalthecoder/OpsTwin-AI/stargazers"><img src="https://img.shields.io/github/stars/Noufalthecoder/OpsTwin-AI?style=for-the-badge&color=09090b&labelColor=27272a&logo=github" alt="Stars" /></a>
    <a href="https://github.com/Noufalthecoder/OpsTwin-AI/network/members"><img src="https://img.shields.io/github/forks/Noufalthecoder/OpsTwin-AI?style=for-the-badge&color=09090b&labelColor=27272a&logo=github" alt="Forks" /></a>
    <a href="https://github.com/Noufalthecoder/OpsTwin-AI/issues"><img src="https://img.shields.io/github/issues/Noufalthecoder/OpsTwin-AI?style=for-the-badge&color=09090b&labelColor=27272a&logo=github" alt="Issues" /></a>
    <a href="https://github.com/Noufalthecoder/OpsTwin-AI/graphs/contributors"><img src="https://img.shields.io/github/contributors/Noufalthecoder/OpsTwin-AI?style=for-the-badge&color=09090b&labelColor=27272a&logo=github" alt="Contributors" /></a>
    <a href="https://github.com/Noufalthecoder/OpsTwin-AI/blob/main/LICENSE"><img src="https://img.shields.io/github/license/Noufalthecoder/OpsTwin-AI?style=for-the-badge&color=09090b&labelColor=27272a" alt="License" /></a>
  </p>
  ...
  <p align="center">
    ...
    <img src="https://img.shields.io/badge/Lemma-FF4F00?style=for-the-badge&logo=awslambda&logoColor=white" alt="Lemma" />
  </p>
</div>
...
<div align="center">
  <img src="https://raw.githubusercontent.com/Noufalthecoder/OpsTwin-AI/main/public/demo.gif" alt="Product Demo GIF" width="800" style="border-radius: 8px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.3);" />
</div>
...
```mermaid
graph TD
    classDef agent fill:#0f172a,stroke:#3b82f6,stroke-width:2px,color:#fff,rx:8px;
    classDef datastore fill:#1e293b,stroke:#10b981,stroke-width:2px,color:#fff,rx:8px;
    classDef user fill:#09090b,stroke:#a855f7,stroke-width:2px,color:#fff,rx:8px;

    User[User Input / Data Upload]:::user
    
    DA[Document Intelligence Agent]:::agent
    WDA[Workflow Discovery Agent]:::agent
    KGA[Knowledge Graph Agent]:::agent
    BDA[Bottleneck Detection Agent]:::agent
    WOA[Workflow Optimization Agent]:::agent
    CA[Compliance Agent]:::agent
    Copilot[Conversational Copilot]:::agent
    ERA[Executive Report Agent]:::agent

    Graph[(Knowledge Graph)]:::datastore
    DB[(Vector Database)]:::datastore

    User --> DA
    DA --> |Extracted Entities| WDA
    WDA --> |Process Logic| KGA
    KGA --> |Semantic Mapping| Graph
    KGA --> DB
    
    Graph --> BDA
    DB --> BDA
    
    BDA --> |Identified Inefficiencies| WOA
    WOA --> |Proposed BPMN| CA
    CA --> |Approved Changes| Copilot
    CA --> |Approved Changes| ERA
...
| :--- | :--- | :--- |
| **Frontend** | ![React](https://img.shields.io/badge/-React-09090b?style=flat-square&logo=react) ![Next.js](https://img.shields.io/badge/-Next.js-09090b?style=flat-square&logo=next.js) | Component-driven UI |
| **Styling** | ![Tailwind](https://img.shields.io/badge/-TailwindCSS-09090b?style=flat-square&logo=tailwindcss) ![Framer](https://img.shields.io/badge/-FramerMotion-09090b?style=flat-square&logo=framer) | Utility-first styling & animations |
| **Backend** | ![FastAPI](https://img.shields.io/badge/-FastAPI-09090b?style=flat-square&logo=fastapi) ![Python](https://img.shields.io/badge/-Python-09090b?style=flat-square&logo=python) | High-performance async API |
| **Orchestration**| ![Lemma](https://img.shields.io/badge/-Lemma-09090b?style=flat-square&logo=awslambda) | Multi-Agent runtime platform |
| **LLM Inference**| ![Gemini](https://img.shields.io/badge/-Google_Gemini-09090b?style=flat-square&logo=googlebard) | Foundational models |
| **Diagramming** | ![Mermaid](https://img.shields.io/badge/-Mermaid.js-09090b?style=flat-square&logo=mermaid) | Dynamic workflow rendering |
| **Database** | ![PostgreSQL](https://img.shields.io/badge/-PostgreSQL-09090b?style=flat-square&logo=postgresql) | Persistent storage |
...
<div align="center">
  <a href="https://github.com/Noufalthecoder">
    <img src="https://github.com/Noufalthecoder.png" width="80" style="border-radius:50%; margin: 10px;" alt="Noufal" />
  </a>
</div>
